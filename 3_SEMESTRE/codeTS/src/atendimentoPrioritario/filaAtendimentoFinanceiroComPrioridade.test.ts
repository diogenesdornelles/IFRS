...
const fila = new FilaAtendimentoFinanceiroComPrioridade();
...
test('inserir dois clientes na fila, sendo o último prioritário', () => {
  ...
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Mario, senha: F002, idade: 67, gravida: false, pcd: false, prioritario: true},Cliente{nome: Ana, senha: F001, idade: 40, gravida: false, pcd: false, prioritario: false}]',
  );
});
...
test('inserir um cliente na fila, sendo prioritário', () => {
  ...
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Mario, senha: F002, idade: 67, gravida: false, pcd: false, prioritario: true},Cliente{nome: Silvia, senha: F003, idade: 32, gravida: true, pcd: false, prioritario: true},Cliente{nome: Ana, senha: F001, idade: 40, gravida: false, pcd: false, prioritario: false}]',
  );
});
...
test('atender um cliente', () => {
  expect(fila.realizarAtendimento()).toBe(
    'Cliente{nome: Mario, senha: F002, idade: 67, gravida: false, pcd: false, prioritario: true}',
  );
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Silvia, senha: F003, idade: 32, gravida: true, pcd: false, prioritario: true},Cliente{nome: Ana, senha: F001, idade: 40, gravida: false, pcd: false, prioritario: false},Cliente{nome: Joao, senha: F004, idade: 29, gravida: false, pcd: false, prioritario: false}]',
  );
});
...
test('atender tres clientes', () => {
  expect(fila.realizarAtendimento()).toBe(
    'Cliente{nome: Silvia, senha: F003, idade: 32, gravida: true, pcd: false, prioritario: true}',
  );
  expect(fila.realizarAtendimento()).toBe(
    'Cliente{nome: Augusto, senha: F006, idade: 23, gravida: false, pcd: true, prioritario: true}',
  );
  expect(fila.realizarAtendimento()).toBe(
    'Cliente{nome: Ana, senha: F001, idade: 40, gravida: false, pcd: false, prioritario: false}',
  );
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Joao, senha: F004, idade: 29, gravida: false, pcd: false, prioritario: false},Cliente{nome: Paulo, senha: F005, idade: 53, gravida: false, pcd: false, prioritario: false}]',
  );
});
