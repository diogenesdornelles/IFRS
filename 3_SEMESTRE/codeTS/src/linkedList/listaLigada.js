...
var ListaLigada = /** @class */ (function () {
    ...
    Object.defineProperty(ListaLigada.prototype, "primeira", {
        /**
    ...
    Object.defineProperty(ListaLigada.prototype, "totalDeElemento", {
        /**
    ...
    Object.defineProperty(ListaLigada.prototype, "ultima", {
        /**
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype.adicionaNoFim = function (elemento) {
        // cria uma célula com o elemento fornecido, definindo próximo como null
        var celula = new celula_1.Celula(elemento, null);
        if (this._ultima) {
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype._posicaoOcupada = function (posicao) {
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype._obtemCelula = function (posicao) {
        var count = 0;
        var celulaAtual = this._primeira;
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype.adicionaPorPosicao = function (posicao, elemento) {
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype.removePorPosicao = function (posicao) {
        // se a posição é fora do range, retorna
        if (!this._posicaoOcupada(posicao))
            return;
        // se não há elementos na lista ligada ou apenas dois elementos, e a inserção é em 0, sem célula anterior, adiciona no começo
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype.obtemElemento = function (posicao) {
        if (this._posicaoOcupada(posicao)) {
     ...
     * @memberof ListaLigada
     */
    ListaLigada.prototype.contem = function (elemento) {
        var celulaAtual = this._primeira;
        if (celulaAtual) {
