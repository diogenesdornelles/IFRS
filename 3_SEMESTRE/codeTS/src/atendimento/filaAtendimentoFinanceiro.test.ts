...
const fila = new FilaAtendimentoFinanceiro();
...
test('inserir tres clientes na fila', () => {
  ...
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Luiz, senha: F001},Cliente{nome: Ana, senha: F002},Cliente{nome: Mario, senha: F003}]',
  );
});
...
test('inserir mais tres clientes na fila', () => {
  ...
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Mario, senha: F003},Cliente{nome: Augusto, senha: F004},Cliente{nome: Joao, senha: F005},Cliente{nome: Paula, senha: F006}]',
  );
});
...
test('realizar mais dois atentimentos', () => {
  ...
  expect(fila.atualizarFilaAtendimento()).toBe(
    '[Cliente{nome: Joao, senha: F005},Cliente{nome: Paula, senha: F006}]',
  );
